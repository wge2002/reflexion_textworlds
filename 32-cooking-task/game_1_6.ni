...
The r_0 and the r_2 and the r_7 and the r_6 and the r_3 and the r_4 and the r_5 and the r_1 and the r_8 are rooms.
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " What's that over there? It looks like it's a table. The table is massive.[if there is something on the s_0] On the table you make out [a list of things on the s_0].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " Look out! It's a- oh, never mind, it's just a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You can make out a stove. [if there is something on the stove_0]On the stove you see [a list of things on the stove_0]. Classic TextWorld.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a patio table. [if there is something on the s_7]You see [a list of things on the s_7] on the patio table. Hmmm... what else, what else?[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "This might come as a shock to you, but you've just entered a livingroom.
 ...
 You make out a sofa! The sofa is comfy.[if there is something on the s_6] On the sofa you make out [a list of things on the s_6]. It doesn't get more TextWorld than this![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. An usual kind of place. Let's see what's in here.
 ...
 You see a gleam over in a corner, where you can see a bed. The bed is large.[if there is something on the s_5] On the bed you can see [a list of things on the s_5]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. An usual one.
 ...
 You scan the room, seeing a toilet. [if there is something on the s_3]On the toilet you make out [a list of things on the s_3]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " You see a workbench. The workbench is wooden.[if there is something on the s_8] On the workbench you can make out [a list of things on the s_8]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The r_0 and the r_2 and the r_7 and the r_6 and the r_3 and the r_4 and the r_5 and the r_1 and the r_8 are rooms.
The r_0 and the r_2 and the r_7 and the r_6 and the r_3 and the r_4 and the r_5 and the r_1 and the r_8 are privately-named.
...
Test quest1_0 with "inventory / go north / go north / go east / examine cookbook / drop red hot pepper / drop white onion / take red potato from counter / cook red onion with stove"
...
Test quest2_0 with "inventory / go north / go north / go east / examine cookbook / drop red hot pepper / drop white onion / take red potato from counter / cook red onion with stove / cook red potato with oven / take knife from table / chop red onion with knife"
...
Test quest4_0 with "inventory / go north / go north / go east / examine cookbook / drop red hot pepper / drop white onion / take red potato from counter"
...
Test quest5_0 with "inventory / go north / go north / go east / examine cookbook / drop red hot pepper / drop white onion / take red potato from counter / cook red onion with stove / cook red potato with oven"
...
Test quest6_0 with "inventory / go north / go north / go east / examine cookbook / drop red hot pepper / drop white onion / take red potato from counter / cook red onion with stove / cook red potato with oven / take knife from table / chop red onion with knife / drop knife / take knife / dice red potato with knife"
...
Test quest7_0 with "inventory / go north / go north / go east / examine cookbook / drop red hot pepper / drop white onion / take red potato from counter / cook red onion with stove / cook red potato with oven / take knife from table / chop red onion with knife / drop knife / take knife / dice red potato with knife / drop knife / prepare meal"
...
Test quest8_0 with "inventory / go north / go north / go east / examine cookbook / drop red hot pepper / drop white onion / take red potato from counter / cook red onion with stove / cook red potato with oven / take knife from table / chop red onion with knife / drop knife / take knife / dice red potato with knife / drop knife / prepare meal / eat meal"
