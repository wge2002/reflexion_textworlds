...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You see a stove. What a coincidence, weren't you just thinking about a stove? [if there is something on the stove_0]On the stove you make out [a list of things on the stove_0].[end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " frosted-glass door leading north. There is an exit to the south. Don't worry, there is no door. There is an exit to the west.".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "Ah, the livingroom. This is some kind of livingroom, really great typical vibes in this place, a wonderful typical atmosphere.

 Oh wow! Is that what I think it is? It is! It's a sofa. The sofa is comfy.[if there is something on the s_5] On the sofa you make out [a list of things on the s_5].[end if]".
...
The corridor part 0 is some text that varies. The corridor part 0 is "A crooked placard tells you that you are now in the corridor. Let's see what's in here.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've just walked into a bathroom. You begin to take stock of what's here.
 ...
 You see a toilet. Why don't you take a picture of it, it'll last longer! [if there is something on the s_3]You see [a list of things on the s_3] on the toilet.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Of every bedroom you could have walked into, you had to show up in a standard one.
...
Test quest1_0 with "inventory / go north / go north / examine cookbook / drop green hot pepper / cook orange bell pepper with stove"
...
Test quest2_0 with "inventory / go north / go north / examine cookbook / drop green hot pepper / cook orange bell pepper with stove / take knife from table / dice orange bell pepper with knife"
...
Test quest3_0 with "inventory / go north / go north / examine cookbook / drop green hot pepper / cook orange bell pepper with stove / take knife from table / dice orange bell pepper with knife / drop knife / prepare meal"
...
Test quest4_0 with "inventory / go north / go north / examine cookbook / drop green hot pepper / cook orange bell pepper with stove / take knife from table / dice orange bell pepper with knife / drop knife / prepare meal / eat meal"
