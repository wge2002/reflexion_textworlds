...
The r_0 and the r_4 and the r_1 and the r_3 and the r_2 and the r_6 and the r_7 and the r_5 and the r_8 are rooms.
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a counter. The counter is vast.[if there is something on the s_1] On the counter you make out [a list of things on the s_1]. Classic TextWorld.[end if]".
...
The kitchen part 13 is some text that varies. The kitchen part 13 is " frosted-glass door leading west. You don't like doors? Why not try going east, that entranceway is not blocked by one. There is an exit to the north. Don't worry, there is no door.".
...
The corridor part 0 is some text that varies. The corridor part 0 is "Well I'll be, you are in a place we're calling a corridor. You can barely contain your excitement.
...
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_8]But the thing is empty. Aw, here you were, all excited for there to be things on it![end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You find yourself in a livingroom. An usual one.
 ...
 You see a sofa. Now why would someone leave that there? [if there is something on the s_7]You see [a list of things on the s_7] on the sofa.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Well, here we are in a backyard. You can barely contain your excitement.
 ...
 You see a patio table. The patio table is stylish.[if there is something on the s_3] On the patio table you can see [a list of things on the s_3]. Now that's what I call TextWorld![end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a patio chair. You shudder, but continue examining the patio chair. [if there is something on the s_5]You see [a list of things on the s_5] on the patio chair. Huh, weird.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You find yourself in an ordinary kind of place. That is to say, you're in a garden.
...
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_4] But the thing is empty. You think about smashing the workbench to bits, throwing the bits into the garbage, etc, until you get bored and decide to move on.[end if]".
...
The f_8 and the f_9 and the f_0 and the f_1 and the f_2 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 are foods.
The f_8 and the f_9 and the f_0 and the f_1 and the f_2 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 are privately-named.
...
The r_0 and the r_4 and the r_1 and the r_3 and the r_2 and the r_6 and the r_7 and the r_5 and the r_8 are rooms.
The r_0 and the r_4 and the r_1 and the r_3 and the r_2 and the r_6 and the r_7 and the r_5 and the r_8 are privately-named.
...
Test quest1_0 with "inventory / go south / examine cookbook / drop red hot pepper / drop green apple / take yellow potato from counter / cook red apple with oven"
...
Test quest2_0 with "inventory / go south / examine cookbook / drop red hot pepper / drop green apple / take yellow potato from counter / cook red apple with oven / cook yellow potato with stove / take knife from table / chop red apple with knife"
...
Test quest4_0 with "inventory / go south / examine cookbook / drop red hot pepper / drop green apple / take yellow potato from counter"
...
Test quest5_0 with "inventory / go south / examine cookbook / drop red hot pepper / drop green apple / take yellow potato from counter / cook red apple with oven / cook yellow potato with stove"
...
Test quest6_0 with "inventory / go south / examine cookbook / drop red hot pepper / drop green apple / take yellow potato from counter / cook red apple with oven / cook yellow potato with stove / take knife from table / chop red apple with knife / drop knife / take knife / dice yellow potato with knife"
...
Test quest7_0 with "inventory / go south / examine cookbook / drop red hot pepper / drop green apple / take yellow potato from counter / cook red apple with oven / cook yellow potato with stove / take knife from table / chop red apple with knife / drop knife / take knife / dice yellow potato with knife / drop knife / prepare meal"
...
Test quest8_0 with "inventory / go south / examine cookbook / drop red hot pepper / drop green apple / take yellow potato from counter / cook red apple with oven / cook yellow potato with stove / take knife from table / chop red apple with knife / drop knife / take knife / dice yellow potato with knife / drop knife / prepare meal / eat meal"
