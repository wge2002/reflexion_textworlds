...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can make out a stove. [if there is something on the stove_0]You see [a list of things on the stove_0] on the stove. Wow! Just like in the movies![end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "Of every livingroom you could have sauntered into, you had to walk into a normal one.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Well I'll be, you are in a place we're calling a bathroom.
 ...
 You can make out a toilet. [if there is something on the s_8]On the toilet you can see [a list of things on the s_8].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a patio table. [if there is something on the s_5]On the patio table you can see [a list of things on the s_5], so there's that.[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You've entered a shed.
 ...
 Look out! It's a- oh, never mind, it's just a toolbox![if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1], so there's that.[end if]".
...
Test quest1_0 with "inventory / examine cookbook / drop yellow onion / drop red bell pepper / take yellow apple from counter"
...
Test quest2_0 with "inventory / examine cookbook / drop yellow onion / drop red bell pepper / take yellow apple from counter / cook yellow apple with oven"
...
Test quest3_0 with "inventory / examine cookbook / drop yellow onion / drop red bell pepper / take yellow apple from counter / cook yellow apple with oven / cook yellow bell pepper with oven / take knife from table / dice yellow apple with knife"
...
Test quest5_0 with "inventory / examine cookbook / drop yellow onion / drop red bell pepper / take yellow apple from counter / cook yellow apple with oven / cook yellow bell pepper with oven"
...
Test quest6_0 with "inventory / examine cookbook / drop yellow onion / drop red bell pepper / take yellow apple from counter / cook yellow apple with oven / cook yellow bell pepper with oven / take knife from table / dice yellow apple with knife / drop knife / take knife / chop yellow bell pepper with knife"
...
Test quest7_0 with "inventory / examine cookbook / drop yellow onion / drop red bell pepper / take yellow apple from counter / cook yellow apple with oven / cook yellow bell pepper with oven / take knife from table / dice yellow apple with knife / drop knife / take knife / chop yellow bell pepper with knife / drop knife / prepare meal"
...
Test quest8_0 with "inventory / examine cookbook / drop yellow onion / drop red bell pepper / take yellow apple from counter / cook yellow apple with oven / cook yellow bell pepper with oven / take knife from table / dice yellow apple with knife / drop knife / take knife / chop yellow bell pepper with knife / drop knife / prepare meal / eat meal"
