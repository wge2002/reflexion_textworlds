...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You have come into a kitchen. Not the kitchen you'd expect. No, this is a kitchen. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a table. Now why would someone leave that there? The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You are in a livingroom. A standard one. You start to take note of what's in the room.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just sauntered into a bedroom.
 ...
 You can see a bed. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the s_4]On the bed you can make out [a list of things on the s_4]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've just walked into a bathroom. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
 ...
 You scan the room for a toilet, and you find a toilet. [if there is something on the s_5]You see [a list of things on the s_5] on the toilet. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "Look at you, bigshot, walking into a pantry like it isn't some huge deal. You try to gain information on your surroundings by using a technique you call 'looking.'
 ...
 You bend down to tie your shoe. When you stand up, you notice a shelf. What a coincidence, weren't you just thinking about a shelf? The shelf is wooden.[if there is something on the s_2] On the shelf you can see [a list of things on the s_2].[end if]".
...
Test quest1_0 with "inventory / go north / go east / examine cookbook / drop yellow potato / cook purple potato with oven"
...
Test quest2_0 with "inventory / go north / go east / examine cookbook / drop yellow potato / cook purple potato with oven / take knife from table / chop purple potato with knife"
...
Test quest3_0 with "inventory / go north / go east / examine cookbook / drop yellow potato / cook purple potato with oven / take knife from table / chop purple potato with knife / drop knife / prepare meal"
...
Test quest4_0 with "inventory / go north / go east / examine cookbook / drop yellow potato / cook purple potato with oven / take knife from table / chop purple potato with knife / drop knife / prepare meal / eat meal"
