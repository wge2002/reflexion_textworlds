...
The r_0 and the r_1 and the r_2 and the r_5 and the r_4 and the r_8 and the r_6 and the r_3 and the r_7 are rooms.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well, here we are in a kitchen. You begin to take stock of what's here.
 ...
 You can make out a fridge. The light flickers for a second, but nothing else happens.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. The light flickers for a second, but nothing else happens.[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_1]But there isn't a thing on it. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
...
The kitchen part 13 is some text that varies. The kitchen part 13 is " patio door leading south. There is an exit to the north. There is an exit to the west. Don't worry, there is no door.".
...
The corridor part 0 is some text that varies. The corridor part 0 is "You find yourself in a corridor. A typical one. Let's see what's in here.
...
The garden part 0 is some text that varies. The garden part 0 is "You find yourself in a garden. A normal one. You begin to take stock of what's here.
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A normal one.
 ...
 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a patio chair. Why don't you take a picture of it, it'll last longer! The patio chair is stylish.[if there is something on the s_6] On the patio chair you can see [a list of things on the s_6].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You smell a terrible smell, and follow it to a patio table. The patio table is stylish.[if there is something on the s_7] On the patio table you make out [a list of things on the s_7]. Now that's what I call TextWorld![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well how about that, you are in a place we're calling a bedroom. You begin looking for stuff.

 You see a gleam over in a corner, where you can see a bed. [if there is something on the s_3]On the bed you can see [a list of things on the s_3]. Hmmm... what else, what else?[end if]".
...
The shed part 3 is some text that varies. The shed part 3 is " You make out a workbench. The workbench is wooden.[if there is something on the s_8] On the workbench you can make out [a list of things on the s_8]. You shudder, but continue examining the room.[end if]".
...
The r_0 and the r_1 and the r_2 and the r_5 and the r_4 and the r_8 and the r_6 and the r_3 and the r_7 are rooms.
The r_0 and the r_1 and the r_2 and the r_5 and the r_4 and the r_8 and the r_6 and the r_3 and the r_7 are privately-named.
...
Test quest1_0 with "inventory / open patio door / go north / examine cookbook / drop yellow apple / drop orange bell pepper / open fridge / take pork chop from fridge"
...
Test quest2_0 with "inventory / open patio door / go north / examine cookbook / drop yellow apple / drop orange bell pepper / open fridge / take pork chop from fridge / cook pork chop with oven"
...
Test quest3_0 with "inventory / open patio door / go north / examine cookbook / drop yellow apple / drop orange bell pepper / open fridge / take pork chop from fridge / cook pork chop with oven / cook yellow bell pepper with oven / take knife from counter / slice pork chop with knife"
...
Test quest5_0 with "inventory / open patio door / go north / examine cookbook / drop yellow apple / drop orange bell pepper / open fridge / take pork chop from fridge / cook pork chop with oven / cook yellow bell pepper with oven"
...
Test quest7_0 with "inventory / open patio door / go north / examine cookbook / drop yellow apple / drop orange bell pepper / open fridge / take pork chop from fridge / cook pork chop with oven / cook yellow bell pepper with oven / take knife from counter / slice pork chop with knife / drop knife / take knife / dice yellow bell pepper with knife / drop knife / prepare meal"
...
Test quest8_0 with "inventory / open patio door / go north / examine cookbook / drop yellow apple / drop orange bell pepper / open fridge / take pork chop from fridge / cook pork chop with oven / cook yellow bell pepper with oven / take knife from counter / slice pork chop with knife / drop knife / take knife / dice yellow bell pepper with knife / drop knife / prepare meal / eat meal"
