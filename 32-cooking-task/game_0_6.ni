...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You see an oven. Huh, weird.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter. Now that's what I call TextWorld![end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can see a stove. [if there is something on the stove_0]On the stove you see [a list of things on the stove_0], so there's that.[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "Fancy seeing you here. Here, by the way, being the pantry. You start to take note of what's in the room.

 You see a shelf. Why don't you take a picture of it, it'll last longer! The shelf is wooden.[if there is something on the s_2] On the shelf you see [a list of things on the s_2]. It doesn't get more TextWorld than this![end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. A typical one.
 ...
 You bend down to tie your shoe. When you stand up, you notice a toilet. The toilet is white.[if there is something on the s_3] On the toilet you see [a list of things on the s_3].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You arrive in a livingroom. An usual kind of place. You begin to take stock of what's here.
 ...
 You can see a sofa. The sofa is comfy.[if there is something on the s_4] On the sofa you make out [a list of things on the s_4]. Now that's what I call TextWorld![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just shown up in a bedroom.
 ...
 What's that over there? It looks like it's a bed. [if there is something on the s_5]On the bed you can make out [a list of things on the s_5]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
Test quest1_0 with "inventory / open plain door / go east / examine cookbook / cook tomato with oven"
...
Test quest2_0 with "inventory / open plain door / go east / examine cookbook / cook tomato with oven / take knife from counter / dice tomato with knife"
...
Test quest3_0 with "inventory / open plain door / go east / examine cookbook / cook tomato with oven / take knife from counter / dice tomato with knife / drop knife / prepare meal"
...
Test quest4_0 with "inventory / open plain door / go east / examine cookbook / cook tomato with oven / take knife from counter / dice tomato with knife / drop knife / prepare meal / eat meal"
...
This is the simpler notify score changes rule:
	...
	if quest1 completed is true and quest2 completed is true and quest3 completed is true and quest4 completed is true:
