...
The r_0 and the r_1 and the r_2 and the r_6 and the r_8 and the r_3 and the r_5 and the r_4 and the r_7 are rooms.
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can make out a stove. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the stove_0]You see [a list of things on the stove_0] on the stove.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the stove_0]The stove appears to be empty. You move on, clearly infuriated by your TextWorld experience.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've entered a backyard. I guess you better just go and list everything you see here.
 ...
 You smell an awful smell, and follow it to a patio chair. The patio chair is stylish.[if there is something on the s_4] On the patio chair you can make out [a list of things on the s_4]. Now that's what I call TextWorld![end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You rest your hand against a wall, but you miss the wall and fall onto a patio table. [if there is something on the s_6]On the patio table you can see [a list of things on the s_6].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Fancy seeing you here. Here, by the way, being the bedroom.
 ...
 Oh wow! Is that what I think it is? It is! It's a bed. The bed is large.[if there is something on the s_8] On the bed you can make out [a list of things on the s_8].[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You are in a shed. A standard kind of place. You begin looking for stuff.

 You see a toolbox. You can't wait to tell the folks at home about this![if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1]. Now that's what I call TextWorld![end if]".
...
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_5]But there isn't a thing on it. You think about smashing the workbench to bits, throwing the bits into the garbage, etc, until you get bored and decide to move on.[end if]".
...
The r_0 and the r_1 and the r_2 and the r_6 and the r_8 and the r_3 and the r_5 and the r_4 and the r_7 are rooms.
The r_0 and the r_1 and the r_2 and the r_6 and the r_8 and the r_3 and the r_5 and the r_4 and the r_7 are privately-named.
...
Test quest1_0 with "inventory / go north / go east / examine cookbook / drop red apple / drop green hot pepper / open fridge / take yellow bell pepper from fridge / open patio door / go east / cook red hot pepper with BBQ"
...
Test quest2_0 with "inventory / go north / go east / examine cookbook / drop red apple / drop green hot pepper / open fridge / take yellow bell pepper from fridge / open patio door / go east / cook red hot pepper with BBQ / cook red hot pepper with BBQ / go west / cook yellow bell pepper with stove / take knife from table / chop red hot pepper with knife"
...
Test quest4_0 with "inventory / go north / go east / examine cookbook / drop red apple / drop green hot pepper / open fridge / take yellow bell pepper from fridge"
...
Test quest5_0 with "inventory / go north / go east / examine cookbook / drop red apple / drop green hot pepper / open fridge / take yellow bell pepper from fridge / open patio door / go east / cook red hot pepper with BBQ / cook red hot pepper with BBQ / go west / cook yellow bell pepper with stove"
...
Test quest6_0 with "inventory / go north / go east / examine cookbook / drop red apple / drop green hot pepper / open fridge / take yellow bell pepper from fridge / open patio door / go east / cook red hot pepper with BBQ / cook red hot pepper with BBQ / go west / cook yellow bell pepper with stove / take knife from table / chop red hot pepper with knife / drop knife / take knife / slice yellow bell pepper with knife"
...
Test quest7_0 with "inventory / go north / go east / examine cookbook / drop red apple / drop green hot pepper / open fridge / take yellow bell pepper from fridge / open patio door / go east / cook red hot pepper with BBQ / cook red hot pepper with BBQ / go west / cook yellow bell pepper with stove / take knife from table / chop red hot pepper with knife / drop knife / take knife / slice yellow bell pepper with knife / drop knife / prepare meal"
...
Test quest8_0 with "inventory / go north / go east / examine cookbook / drop red apple / drop green hot pepper / open fridge / take yellow bell pepper from fridge / open patio door / go east / cook red hot pepper with BBQ / cook red hot pepper with BBQ / go west / cook yellow bell pepper with stove / take knife from table / chop red hot pepper with knife / drop knife / take knife / slice yellow bell pepper with knife / drop knife / prepare meal / eat meal"
