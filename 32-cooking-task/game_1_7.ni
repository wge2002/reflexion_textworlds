...
The r_0 and the r_2 and the r_6 and the r_7 and the r_3 and the r_4 and the r_5 and the r_8 and the r_1 are rooms.
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " Oh wow! Is that what I think it is? It is! It's a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter. Classic TextWorld.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. An usual one. You begin looking for stuff.
...
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_3]But the thing is empty, unfortunately. Aw, and here you were, all excited for there to be things on it![end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " As if things weren't amazing enough already, you can even see a patio chair. The patio chair is stylish.[if there is something on the s_5] On the patio chair you see [a list of things on the s_5]. Wow! Just like in the movies![end if]".
...
The shed part 3 is some text that varies. The shed part 3 is " You see a workbench. [if there is something on the s_6]On the workbench you can see [a list of things on the s_6]. It doesn't get more TextWorld than this![end if]".
The shed part 4 is some text that varies. The shed part 4 is "[if there is nothing on the s_6]Looks like someone's already been here and taken everything off it, though. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Of every bathroom you could have walked into, you had to walk into a normal one.
...
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_7] The toilet appears to be empty. You move on, clearly infuriated by TextWorld.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A standard kind of place.
 ...
 Look over there! a bed. [if there is something on the s_4]On the bed you make out [a list of things on the s_4].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You are in a livingroom. An ordinary kind of place.
 ...
 You scan the room, seeing a sofa. [if there is something on the s_8]On the sofa you can make out [a list of things on the s_8].[end if]".
...
The f_7 and the f_9 and the f_0 and the f_1 and the f_10 and the f_11 and the f_2 and the f_3 and the f_4 and the f_5 and the f_6 and the f_8 are foods.
The f_7 and the f_9 and the f_0 and the f_1 and the f_10 and the f_11 and the f_2 and the f_3 and the f_4 and the f_5 and the f_6 and the f_8 are privately-named.
...
The r_0 and the r_2 and the r_6 and the r_7 and the r_3 and the r_4 and the r_5 and the r_8 and the r_1 are rooms.
The r_0 and the r_2 and the r_6 and the r_7 and the r_3 and the r_4 and the r_5 and the r_8 and the r_1 are privately-named.
...
Test quest1_0 with "inventory / go north / open patio door / go west / examine cookbook / drop red potato / drop orange bell pepper / open fridge / take white tuna from fridge / cook red hot pepper with oven"
...
Test quest2_0 with "inventory / go north / open patio door / go west / examine cookbook / drop red potato / drop orange bell pepper / open fridge / take white tuna from fridge / cook red hot pepper with oven / cook white tuna with stove / take knife from table / dice red hot pepper with knife"
...
Test quest4_0 with "inventory / go north / open patio door / go west / examine cookbook / drop red potato / drop orange bell pepper / open fridge / take white tuna from fridge"
...
Test quest5_0 with "inventory / go north / open patio door / go west / examine cookbook / drop red potato / drop orange bell pepper / open fridge / take white tuna from fridge / cook red hot pepper with oven / cook white tuna with stove"
...
Test quest6_0 with "inventory / go north / open patio door / go west / examine cookbook / drop red potato / drop orange bell pepper / open fridge / take white tuna from fridge / cook red hot pepper with oven / cook white tuna with stove / take knife from table / dice red hot pepper with knife / drop knife / take knife / chop white tuna with knife"
...
Test quest7_0 with "inventory / go north / open patio door / go west / examine cookbook / drop red potato / drop orange bell pepper / open fridge / take white tuna from fridge / cook red hot pepper with oven / cook white tuna with stove / take knife from table / dice red hot pepper with knife / drop knife / take knife / chop white tuna with knife / drop knife / prepare meal"
...
Test quest8_0 with "inventory / go north / open patio door / go west / examine cookbook / drop red potato / drop orange bell pepper / open fridge / take white tuna from fridge / cook red hot pepper with oven / cook white tuna with stove / take knife from table / dice red hot pepper with knife / drop knife / take knife / chop white tuna with knife / drop knife / prepare meal / eat meal"
