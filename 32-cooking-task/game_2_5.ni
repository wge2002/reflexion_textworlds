...
The r_0 and the r_2 and the r_1 and the r_4 and the r_3 and the r_8 and the r_6 and the r_5 and the r_7 are rooms.
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can make out a table. Make a note of this, you might have to put stuff on or in it later on. The table is massive.[if there is something on the s_0] On the table you can make out [a list of things on the s_0].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_0] However, the table, like an empty table, has nothing on it. You swear loudly.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You are in a livingroom. A standard kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_7] But the thing is empty, unfortunately. You make a mental note to not get your hopes up the next time you see a toilet in a room.[end if]".
...
The shed part 3 is some text that varies. The shed part 3 is " You see a workbench. The workbench is wooden.[if there is something on the s_3] On the workbench you make out [a list of things on the s_3]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've entered a backyard.
 ...
 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a patio chair. The patio chair is stylish.[if there is something on the s_5] On the patio chair you see [a list of things on the s_5]. Now that's what I call TextWorld![end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_5] Unfortunately, there isn't a thing on it. Oh! Why couldn't there just be stuff on it?[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a patio table. [if there is something on the s_6]On the patio table you make out [a list of things on the s_6].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. An ordinary one.
 ...
 Hey, want to see a bed? Look over there, a bed. [if there is something on the s_8]On the bed you can see [a list of things on the s_8].[end if]".
...
The f_13 and the f_8 and the f_0 and the f_1 and the f_2 and the f_10 and the f_11 and the f_12 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_9 are foods.
The f_13 and the f_8 and the f_0 and the f_1 and the f_2 and the f_10 and the f_11 and the f_12 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_9 are privately-named.
...
The r_0 and the r_2 and the r_1 and the r_4 and the r_3 and the r_8 and the r_6 and the r_5 and the r_7 are rooms.
The r_0 and the r_2 and the r_1 and the r_4 and the r_3 and the r_8 and the r_6 and the r_5 and the r_7 are privately-named.
...
Test quest1_0 with "inventory / go north / go east / examine cookbook / drop yellow onion / take red potato from counter"
...
Test quest2_0 with "inventory / go north / go east / examine cookbook / drop yellow onion / take red potato from counter / open fridge / take yellow bell pepper from fridge / cook red potato with stove"
...
Test quest3_0 with "inventory / go north / go east / examine cookbook / drop yellow onion / take red potato from counter / open fridge / take yellow bell pepper from fridge / cook red potato with stove / cook yellow bell pepper with oven / cook yellow potato with stove / take knife from table / slice red potato with knife"
...
Test quest5_0 with "inventory / go north / go east / examine cookbook / drop yellow onion / take red potato from counter / open fridge / take yellow bell pepper from fridge"
...
Test quest6_0 with "inventory / go north / go east / examine cookbook / drop yellow onion / take red potato from counter / open fridge / take yellow bell pepper from fridge / cook red potato with stove / cook yellow bell pepper with oven"
...
Test quest7_0 with "inventory / go north / go east / examine cookbook / drop yellow onion / take red potato from counter / open fridge / take yellow bell pepper from fridge / cook red potato with stove / cook yellow bell pepper with oven / cook yellow potato with stove / take knife from table / slice red potato with knife / drop knife / take knife / dice yellow bell pepper with knife"
...
Test quest9_0 with "inventory / go north / go east / examine cookbook / drop yellow onion / take red potato from counter / open fridge / take yellow bell pepper from fridge / cook red potato with stove / cook yellow bell pepper with oven / cook yellow potato with stove"
...
Test quest10_0 with "inventory / go north / go east / examine cookbook / drop yellow onion / take red potato from counter / open fridge / take yellow bell pepper from fridge / cook red potato with stove / cook yellow bell pepper with oven / cook yellow potato with stove / take knife from table / slice red potato with knife / drop knife / take knife / dice yellow bell pepper with knife / drop knife / take knife / chop yellow potato with knife"
...
Test quest11_0 with "inventory / go north / go east / examine cookbook / drop yellow onion / take red potato from counter / open fridge / take yellow bell pepper from fridge / cook red potato with stove / cook yellow bell pepper with oven / cook yellow potato with stove / take knife from table / slice red potato with knife / drop knife / take knife / dice yellow bell pepper with knife / drop knife / take knife / chop yellow potato with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / go north / go east / examine cookbook / drop yellow onion / take red potato from counter / open fridge / take yellow bell pepper from fridge / cook red potato with stove / cook yellow bell pepper with oven / cook yellow potato with stove / take knife from table / slice red potato with knife / drop knife / take knife / dice yellow bell pepper with knife / drop knife / take knife / chop yellow potato with knife / drop knife / prepare meal / eat meal"
