...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You can make out a stove. The stove is conventional.[if there is something on the stove_0] On the stove you see [a list of things on the stove_0], so there's that.[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the stove_0] But oh no! there's nothing on this piece of trash. You move on, clearly done caring about your TextWorld experience.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You've just shown up in a livingroom.
 ...
 Hey, want to see a sofa? Look over there, a sofa. The sofa is comfy.[if there is something on the s_5] On the sofa you make out [a list of things on the s_5].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Guess what, you are in a place we're calling a bathroom. Let's see what's in here.
 ...
 You see a toilet. [if there is something on the s_3]On the toilet you can see [a list of things on the s_3]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_3]But the thing hasn't got anything on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The pantry part 1 is some text that varies. The pantry part 1 is "[if there is nothing on the s_2] However, the shelf, like an empty shelf, has nothing on it. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
...
Test quest1_0 with "inventory / go east / go east / examine cookbook / cook block of cheese with oven"
...
Test quest2_0 with "inventory / go east / go east / examine cookbook / cook block of cheese with oven / take knife from counter / dice block of cheese with knife"
...
Test quest3_0 with "inventory / go east / go east / examine cookbook / cook block of cheese with oven / take knife from counter / dice block of cheese with knife / drop knife / prepare meal"
...
Test quest4_0 with "inventory / go east / go east / examine cookbook / cook block of cheese with oven / take knife from counter / dice block of cheese with knife / drop knife / prepare meal / eat meal"
