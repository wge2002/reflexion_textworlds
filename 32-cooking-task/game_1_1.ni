...
The r_0 and the r_3 and the r_1 and the r_4 and the r_6 and the r_7 and the r_5 and the r_8 and the r_2 are rooms.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a table. The table is massive.[if there is something on the s_0] On the table you see [a list of things on the s_0]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You rest your hand against a wall, but you miss the wall and fall onto a stove. [if there is something on the stove_0]You see [a list of things on the stove_0] on the stove. Wow! Just like in the movies![end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You are in a livingroom. A standard one.
 ...
 You can make out a sofa. I guess it's true what they say, if you're looking for a sofa, go to TextWorld. The sofa is comfy.[if there is something on the s_5] On the sofa you make out [a list of things on the s_5]. You can't wait to tell the folks at home about this![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A standard kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 You scan the room for a patio table, and you find a patio table. [if there is something on the s_4]On the patio table you make out [a list of things on the s_4]. Wow! Just like in the movies![end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Were you looking for a patio chair? Because look over there, it's a patio chair. I guess it's true what they say, if you're looking for a patio chair, go to TextWorld. The patio chair is stylish.[if there is something on the s_8] On the patio chair you make out [a list of things on the s_8].[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " Oh wow! Is that what I think it is? It is! It's a workbench. The workbench is wooden.[if there is something on the s_7] On the workbench you can make out [a list of things on the s_7].[end if]".
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_7] Looks like someone's already been here and taken everything off it, though. It would have been so cool if there was stuff on the workbench.[end if]".
...
The r_0 and the r_3 and the r_1 and the r_4 and the r_6 and the r_7 and the r_5 and the r_8 and the r_2 are rooms.
The r_0 and the r_3 and the r_1 and the r_4 and the r_6 and the r_7 and the r_5 and the r_8 and the r_2 are privately-named.
...
Test quest1_0 with "inventory / go east / go south / examine cookbook / drop yellow potato / take red hot pepper from counter / cook purple potato with stove"
...
Test quest2_0 with "inventory / go east / go south / examine cookbook / drop yellow potato / take red hot pepper from counter / cook purple potato with stove / open patio door / go east / cook red hot pepper with BBQ / cook red hot pepper with BBQ / go west / take knife from table / chop purple potato with knife"
...
Test quest4_0 with "inventory / go east / go south / examine cookbook / drop yellow potato / take red hot pepper from counter"
...
Test quest5_0 with "inventory / go east / go south / examine cookbook / drop yellow potato / take red hot pepper from counter / cook purple potato with stove / open patio door / go east / cook red hot pepper with BBQ"
...
Test quest6_0 with "inventory / go east / go south / examine cookbook / drop yellow potato / take red hot pepper from counter / cook purple potato with stove / open patio door / go east / cook red hot pepper with BBQ / cook red hot pepper with BBQ / go west / take knife from table / chop purple potato with knife / drop knife / take knife / dice red hot pepper with knife"
...
Test quest7_0 with "inventory / go east / go south / examine cookbook / drop yellow potato / take red hot pepper from counter / cook purple potato with stove / open patio door / go east / cook red hot pepper with BBQ / cook red hot pepper with BBQ / go west / take knife from table / chop purple potato with knife / drop knife / take knife / dice red hot pepper with knife / drop knife / prepare meal"
...
Test quest8_0 with "inventory / go east / go south / examine cookbook / drop yellow potato / take red hot pepper from counter / cook purple potato with stove / open patio door / go east / cook red hot pepper with BBQ / cook red hot pepper with BBQ / go west / take knife from table / chop purple potato with knife / drop knife / take knife / dice red hot pepper with knife / drop knife / prepare meal / eat meal"
