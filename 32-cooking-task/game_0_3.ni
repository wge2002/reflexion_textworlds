...
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_1]Looks like someone's already been here and taken everything off it, though. You think about smashing the counter to bits, throwing the bits into the garbage, etc, until you get bored and decide to move on.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. An usual kind of place.
 ...
 As if things weren't amazing enough already, you can even see a bed. The bed is large.[if there is something on the s_5] On the bed you see [a list of things on the s_5].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "Well, here we are in a livingroom. You begin looking for stuff.

 You see a sofa. [if there is something on the s_3]You see [a list of things on the s_3] on the sofa. Wow! Just like in the movies![end if]".
...
Test quest1_0 with "inventory / go west / go south / go west / examine cookbook / drop red tuna / drop yellow potato / cook red potato with stove"
...
Test quest2_0 with "inventory / go west / go south / go west / examine cookbook / drop red tuna / drop yellow potato / cook red potato with stove / take knife from table / slice red potato with knife"
...
Test quest3_0 with "inventory / go west / go south / go west / examine cookbook / drop red tuna / drop yellow potato / cook red potato with stove / take knife from table / slice red potato with knife / drop knife / prepare meal"
...
Test quest4_0 with "inventory / go west / go south / go west / examine cookbook / drop red tuna / drop yellow potato / cook red potato with stove / take knife from table / slice red potato with knife / drop knife / prepare meal / eat meal"
