...
The kitchen part 3 is some text that varies. The kitchen part 3 is " Oh, great. Here's an oven, so there's that.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " Look out! It's a- oh, never mind, it's just a counter. The counter is vast.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1]. It doesn't get more TextWorld than this![end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've just shown up in a pantry.
 ...
 You can see a shelf. What a coincidence, weren't you just thinking about a shelf? The shelf is wooden.[if there is something on the s_2] On the shelf you can see [a list of things on the s_2].[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is "[if there is nothing on the s_2] However, the shelf, like an empty shelf, has nothing on it. You move on, clearly angry about your TextWorld experience.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You have walked into a bathroom. Not the bathroom you'd expect. No, this is a bathroom. You try to gain information on your surroundings by using a technique you call 'looking.'
 ...
 You can make out a toilet. The toilet is white.[if there is something on the s_3] On the toilet you see [a list of things on the s_3]. It doesn't get more TextWorld than this![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. An ordinary one. I guess you better just go and list everything you see here.
 ...
 You make out a bed. Now why would someone leave that there? [if there is something on the s_4]On the bed you can make out [a list of things on the s_4].[end if]".
...
Test quest1_0 with "inventory / examine cookbook / drop red onion / drop green bell pepper / cook red bell pepper with oven"
...
Test quest2_0 with "inventory / examine cookbook / drop red onion / drop green bell pepper / cook red bell pepper with oven / take knife from table / chop red bell pepper with knife"
...
Test quest3_0 with "inventory / examine cookbook / drop red onion / drop green bell pepper / cook red bell pepper with oven / take knife from table / chop red bell pepper with knife / drop knife / prepare meal"
...
Test quest4_0 with "inventory / examine cookbook / drop red onion / drop green bell pepper / cook red bell pepper with oven / take knife from table / chop red bell pepper with knife / drop knife / prepare meal / eat meal"
